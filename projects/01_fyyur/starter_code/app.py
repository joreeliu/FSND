...
def search_artists():
    ...
    res = db.session.query(Artist).join(Artist.artist_show, isouter=True).filter(
...
def show_artist(artist_id):
    ...
    '''
    res = db.session.query(Artist).join(Artist.genres_artists, isouter=True).join(Artist.artist_show,
                                                                                  isouter=True).filter(
